...
if ( !class_exists( 'MeowKit_DBCLNR_Helpers' ) ) {

  class MeowKit_DBCLNR_Helpers {
    //public static $version = MeowKit_DBCLNR_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_DBCLNR_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_DBCLNR_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_DBCLNR_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_DBCLNR_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_DBCLNR_Helpers::$startQueries[ $timerName ];
