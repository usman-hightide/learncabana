...
<style>
	div#singleUserProfileDateLogin, div#singleUserProfileDateRegistered {
		font-size: 12px;
		color: gray;
	}
</style>
				...
				<div class="reporting-dashboard-col-content reporting-dashboard-col-content--no-min-height">
					<div class="reporting-user-card">
						...
						<div class="reporting-user-card__content">
							...
							<div class="reporting-user-card__lastLogin" id="singleUserProfileDateLogin"></div>
							<div class="reporting-user-card__registered" id="singleUserProfileDateRegistered"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div id="userSingleCourseProgressMenuContainer" style="display: none;">
				...
				<ul class="reporting-single-course-progress-tabs" id="userSingleCourseProgressMenu">
					...
					<?php if ( $show_tin_can_menu ) { ?>
						<li class="reporting-single-course-progress-tabs__item" <?php echo self::$tincan_show; ?> id="menuTinCan">
