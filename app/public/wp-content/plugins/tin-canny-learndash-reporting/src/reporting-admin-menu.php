	...
	*/
	...
	public static function scripts( $hook ) {
		...
		if ( $page_is_to_load_scripts ) {
			...
			$isolated_job_title = ultc_get_filter_var( 'job_titles', '' );
			...
			$reporting_api_setup = array(
				...
				'isolated_job_title'            => $isolated_job_title,
	...
	public static function options_menu_page_output() {
		...
		if ( ultc_filter_has_var( 'job_titles' ) ) {
			self::$isolated_job_title = ultc_filter_input( 'job_titles' );
		}
