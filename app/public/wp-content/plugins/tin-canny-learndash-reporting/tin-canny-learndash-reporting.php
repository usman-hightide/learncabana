...
if ( ! defined( 'UNCANNY_REPORTING_VERSION' ) ) {
	define( 'UNCANNY_REPORTING_VERSION', '4.4.0.4' );
}
...
/**
 * LearnDash's Plugins page assets
 */
...
if ( version_compare( PHP_VERSION, '5.3', '>=' ) ) {
	...
	if ( defined( 'LEARNDASH_VERSION' ) ) {
		...
		// common filter var functions
		include_once dirname( __FILE__ ) . '/src/includes/tin-canny-xss-functions.php';
