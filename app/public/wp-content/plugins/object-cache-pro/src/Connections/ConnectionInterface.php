...
/**
 * @method bool close()
 * @method mixed ping(string $arg = null)
 * @method mixed flushdb(?bool $sync = null)
 * @method mixed config(string $operation, mixed $key = null)
 * @method mixed slowlog(string $operation, string ...$extra_args)
 */
