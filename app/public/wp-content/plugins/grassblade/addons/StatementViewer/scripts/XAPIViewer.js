...
Viewer.prototype.XAPISearchHelper = function(){
    ...
    this.getRegistration = function(){
        return this.getSearchVar("registration2");
    };
...
Viewer.prototype.XAPIFormHelper = function(){
    ...
    this.getQueryStringMap = function(){
        ...
        for(var i = 0; i < nameVals.length; i++){
            ...
            qsMap[keyVal[0]] = (typeof keyVal[1] == "undefined")? "":decodeURIComponent(keyVal[1].replace(/\+/g, " "));
        }
        return qsMap;
    };
};
...
Viewer.prototype.renderStatementsHandler = function(xhr){
    this.renderStatements(JSON.parse(this.sanitize(xhr.responseText)));
};
Viewer.prototype.sanitize = function(string) {
