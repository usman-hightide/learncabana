(function(ADL){
    ...
    function PopcornVideo(player, comp) {
        ...
        if (player.media.children && player.media.children[0] && player.media.children[0].src) {
       ...
       // console.log(parseQueryString());
        ...
        function startstuff(launched){
            ...
            if (launched){
                ...
                var resumeTime = myplayer.roundTime();
                stmt["verb"] = ADL.verbs.resumed
                stmt["result"] = {"extensions":{"https://w3id.org/xapi/video/extensions/time":resumeTime}}
            }
            report(stmt);
        }
        function attempted() {
        ...
        function middleStuff(quartile, benchTime) {
            ...
            var bench = benchTime;
            var extKey = "https://w3id.org/xapi/video/extensions/time";//quartile
        ...
        function pauseStuff(pauseTime){
            ...
            var stmt = {"actor":actor, 
                    ...
                    "result":{"extensions":{"https://w3id.org/xapi/video/extensions/time":paused}}}
        ...
        function seekStuff(seekTime){
            ...
            var stmt = {"actor":actor, 
                    ...
                    "object":videoActivity, 
                    "result":{"extensions":{"https://w3id.org/xapi/video/extensions/time-from": seeked}}}
