...
<p>
	...
	<?php _e("However, most of the static content are not protected using these methods. To be able to protect static content from not logged-in users, the content security feature of GrassBlade doesn't allow access to your uploaded content even if someone gets direct url to the content.", "grassblade"); ?>
</p>
</div>
