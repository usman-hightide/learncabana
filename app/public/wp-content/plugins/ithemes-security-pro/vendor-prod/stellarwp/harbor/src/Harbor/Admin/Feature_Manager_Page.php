...
namespace iThemesSecurity\Strauss\LiquidWeb\Harbor\Admin;
...
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Utils\Version;
/**
...
class Feature_Manager_Page
{
    ...
    public function maybe_register_page(): void
    {
        ...
        $this->page_hook = (string) add_submenu_page('options-general.php', __('Liquid Web Software Manager', 'it-l10n-ithemes-security-pro'), __('Liquid Web Products', 'it-l10n-ithemes-security-pro'), 'manage_options', self::PAGE_SLUG, [$this, 'render']);
        /**
