	...
	protected function do_deactivate() {
		...
		return new WP_Error(
			...
			sprintf(
				...
				__( 'The theme "%s" is installed on disk and cannot be deactivated programmatically. Please delete it manually via Appearance → Themes in the WordPress admin.', 'it-l10n-ithemes-security-pro' ),
				$this->feature->get_name()
			)
		);
	}
