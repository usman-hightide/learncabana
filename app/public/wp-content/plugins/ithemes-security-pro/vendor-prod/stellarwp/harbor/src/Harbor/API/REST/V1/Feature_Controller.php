...
namespace iThemesSecurity\Strauss\LiquidWeb\Harbor\API\REST\V1;

use iThemesSecurity\Strauss\LiquidWeb\Harbor\Features\Error_Code;
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Features\Feature_Resource;
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Features\Manager;
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Features\Types\Feature;
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Utils\Cast;
use WP_Error;
...
class Feature_Controller extends WP_REST_Controller {
	...
	public function get_item_schema(): array {
		...
		$base_properties = [
			'slug'              => [
				'description' => __( 'The feature slug.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'name'              => [
				'description' => __( 'The feature display name.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'description'       => [
				'description' => __( 'The feature description.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'product'           => [
				'description' => __( 'The product the feature belongs to.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'tier'              => [
				'description' => __( 'The feature tier.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'type'              => [
				'description' => __( 'The feature type identifier.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'is_available'      => [
				'description' => __( 'Whether the feature is available for the current site.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'boolean',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'in_catalog_tier'   => [
				'description' => __( "True when the user's licensed tier covers this feature's minimum tier.", 'it-l10n-ithemes-security-pro' ),
				'type'        => 'boolean',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'documentation_url' => [
				'description' => __( 'The URL to the feature documentation.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'string',
				'format'      => 'uri',
				'readonly'    => true,
				'context'     => [ 'view' ],
			...
			'is_enabled'        => [
				'description' => __( 'Whether the feature is currently enabled.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'boolean',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
		...
		$installable_properties = [
			'release_date'      => [
				'description' => __( 'Release date of the latest version, or null if not applicable.', 'it-l10n-ithemes-security-pro' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'version'           => [
				'description' => __( 'Latest available version from the catalog, or null. Only present for installable features.', 'it-l10n-ithemes-security-pro' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'changelog'         => [
				'description' => __( 'Changelog HTML for the latest version, or null. Only present for installable features.', 'it-l10n-ithemes-security-pro' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'wporg_slug'        => [
				'description' => __( 'The WordPress.org slug for plugins_api() lookups, or null if not on WordPress.org.', 'it-l10n-ithemes-security-pro' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'installed_version' => [
				'description' => __( 'The currently installed version, or null if not installed.', 'it-l10n-ithemes-security-pro' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'update_version'    => [
				'description' => __( 'Version available in the WordPress update transient, or null when no update is pending.', 'it-l10n-ithemes-security-pro' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
		...
		$plugin_properties = [
			'plugin_file' => [
				'description' => __( 'The plugin file path relative to the plugins directory.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
	...
	public function get_collection_params(): array {
		return [
			'product'   => [
				'description'       => __( 'Filter by product.', 'it-l10n-ithemes-security-pro' ),
				'type'              => 'string',
				'sanitize_callback' => 'sanitize_text_field',
			],
			'tier'      => [
				'description'       => __( 'Filter by feature tier.', 'it-l10n-ithemes-security-pro' ),
				'type'              => 'string',
				'sanitize_callback' => 'sanitize_text_field',
			],
			'available' => [
				'description' => __( 'Filter by availability.', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'boolean',
			],
			'type'      => [
				'description'       => __( 'Filter by feature type.', 'it-l10n-ithemes-security-pro' ),
				'type'              => 'string',
				'sanitize_callback' => 'sanitize_text_field',
			],
		];
