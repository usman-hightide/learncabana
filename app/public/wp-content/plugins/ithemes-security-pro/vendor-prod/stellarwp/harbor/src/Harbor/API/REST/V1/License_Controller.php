...
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Utils\License_Key;
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Licensing\License_Manager;
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Licensing\Product_Collection;
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Site\Data;
use WP_Error;
...
final class License_Controller extends WP_REST_Controller {
		...
		register_rest_route(
			...
			[
				[
					...
					'args'                => [
						'key' => [
							'description'       => __( 'The license key to look up.', 'it-l10n-ithemes-security-pro' ),
							'type'              => 'string',
							'required'          => true,
	...
	public function get_item_schema(): array {
		...
		$this->schema = [
			...
			'properties' => [
				'key'      => [
					'description' => __( 'The unified license key.', 'it-l10n-ithemes-security-pro' ),
					'type'        => [ 'string', 'null' ],
					'context'     => [ 'view' ],
				],
				'products' => [
					'description' => __( 'The products associated with the license key.', 'it-l10n-ithemes-security-pro' ),
					'type'        => 'array',
					'context'     => [ 'view' ],
					'items'       => [
						'type'       => 'object',
						'properties' => [
							'product_slug'      => [
								'description' => __( 'The product identifier.', 'it-l10n-ithemes-security-pro' ),
								'type'        => 'string',
							],
							'tier'              => [
								'description' => __( 'The entitlement tier.', 'it-l10n-ithemes-security-pro' ),
								'type'        => 'string',
							],
							'status'            => [
								'description' => __( 'The entitlement status.', 'it-l10n-ithemes-security-pro' ),
								'type'        => 'string',
							],
							'expires'           => [
								'description' => __( 'The expiration date.', 'it-l10n-ithemes-security-pro' ),
								'type'        => 'string',
								'format'      => 'date-time',
							],
							'activations'       => [
								'description' => __( 'Activation seat data.', 'it-l10n-ithemes-security-pro' ),
								'type'        => 'object',
								'properties'  => [
									'site_limit'   => [
										'description' => __( 'Maximum activation seats (0 = unlimited).', 'it-l10n-ithemes-security-pro' ),
										'type'        => 'integer',
									],
									'active_count' => [
										'description' => __( 'Current active activations.', 'it-l10n-ithemes-security-pro' ),
										'type'        => 'integer',
									],
									'over_limit'   => [
										'description' => __( 'Whether the seat limit is exceeded.', 'it-l10n-ithemes-security-pro' ),
										'type'        => 'boolean',
									],
									'domains'      => [
										'description' => __( 'Activated domain names.', 'it-l10n-ithemes-security-pro' ),
										'type'        => 'array',
										'items'       => [ 'type' => 'string' ],
									],
								],
							...
							'capabilities'      => [
								'description' => __( 'Feature slugs granted by this entitlement.', 'it-l10n-ithemes-security-pro' ),
								'type'        => 'array',
								'items'       => [ 'type' => 'string' ],
							],
							'activated_here'    => [
								'description' => __( 'Whether the product is activated on this domain.', 'it-l10n-ithemes-security-pro' ),
								'type'        => [ 'boolean', 'null' ],
							],
							'validation_status' => [
								'description' => __( 'The validation status for this product.', 'it-l10n-ithemes-security-pro' ),
								'type'        => [ 'string', 'null' ],
							],
							'is_valid'          => [
								'description' => __( 'Whether the product has a valid license.', 'it-l10n-ithemes-security-pro' ),
								'type'        => 'boolean',
							],
						],
					],
				...
				'error'    => [
					'description' => __( 'An error encountered while fetching the license, or null if none.', 'it-l10n-ithemes-security-pro' ),
					'type'        => [ 'object', 'null' ],
					'context'     => [ 'view' ],
					'properties'  => [
						'code'    => [
							'description' => __( 'The error code.', 'it-l10n-ithemes-security-pro' ),
							'type'        => 'string',
						],
						'message' => [
							'description' => __( 'The error message.', 'it-l10n-ithemes-security-pro' ),
							'type'        => 'string',
						],
					],
				],
	...
	private function get_store_args(): array {
		return array_merge(
			[
				'key' => [
					'description'       => __( 'The license key to store.', 'it-l10n-ithemes-security-pro' ),
					'type'              => 'string',
					'required'          => true,
	...
	private function get_network_args(): array {
		return [
			'network' => [
				'description' => __( 'Whether to operate on the network-level key (multisite only).', 'it-l10n-ithemes-security-pro' ),
				'type'        => 'boolean',
				'default'     => false,
			],
		];
