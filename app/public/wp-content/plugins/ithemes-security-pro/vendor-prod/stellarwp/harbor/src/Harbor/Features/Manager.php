...
use iThemesSecurity\Strauss\LiquidWeb\Harbor\Features\Strategy\Strategy_Factory;
	...
	public function enable( string $slug ) {
		...
		if ( $feature->is_in_catalog_tier() && ! $feature->is_available() ) {
			...
			return new WP_Error(
				...
				__( 'This feature has been removed from your license capabilities. Contact support.', 'it-l10n-ithemes-security-pro' )
			);
		}
