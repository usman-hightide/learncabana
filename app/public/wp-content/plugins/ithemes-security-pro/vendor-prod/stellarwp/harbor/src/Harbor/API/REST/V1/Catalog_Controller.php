...
final class Catalog_Controller extends WP_REST_Controller {
	...
	public function get_item_schema(): array {
		...
		$this->schema = [
			...
			'properties' => [
				'product_id'   => [
					'description' => __( 'The product ID from the Commerce Portal.', 'it-l10n-ithemes-security-pro' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'product_slug' => [
					'description' => __( 'The product slug.', 'it-l10n-ithemes-security-pro' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'product_name' => [
					'description' => __( 'The product display name.', 'it-l10n-ithemes-security-pro' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'tiers'        => [
					'description' => __( 'The product tiers ordered by rank.', 'it-l10n-ithemes-security-pro' ),
					'type'        => 'array',
					'readonly'    => true,
					'context'     => [ 'view' ],
					'items'       => [
				...
				'features'     => [
					'description' => __( 'The product features.', 'it-l10n-ithemes-security-pro' ),
					'type'        => 'array',
					'readonly'    => true,
					'context'     => [ 'view' ],
					'items'       => [
