...
/**
 * Manage Kadence Security Pro functionality
 *
...
class ITSEC_WP_CLI_Command_ITSEC extends WP_CLI_Command {
	...
	/**
	 * Resets all Kadence Security data and settings.
	 *
	 * @param array $args
	 * @param array $assoc_args
	 */
	public function reset( $args, $assoc_args ) {
		...
		WP_CLI::confirm( 'Are you sure you want to reset Kadence Security?', $assoc_args );
