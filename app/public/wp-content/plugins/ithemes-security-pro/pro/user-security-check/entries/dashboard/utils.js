...
export function getTwoFactor( twoFactor ) {
	switch ( twoFactor ) {
		...
		case 'not-enabled':
			return { indicator: '#D12502', text: __( 'Disabled', 'it-l10n-ithemes-security-pro' ) };
		case 'not-available':
			return { indicator: '#D12502', text: __( 'Inactive', 'it-l10n-ithemes-security-pro' ) };
		case 'enforced-not-configured':
			return { indicator: '#E86230', text: __( 'Enforced', 'it-l10n-ithemes-security-pro' ) };
		default:
			return { indicator: '#E86230', text: twoFactor };
	}
}
...
export function getPasswordStrength( strength ) {
	switch ( strength ) {
		case 0:
		case 1:
			return { indicator: '#D12502', text: _x( 'Very Weak', 'password strength', 'it-l10n-ithemes-security-pro' ) };
		case 2:
			return { indicator: '#E39219', text: _x( 'Weak', 'password strength', 'it-l10n-ithemes-security-pro' ) };
		case 3:
			return { indicator: '#E86230', text: _x( 'Medium', 'password strength', 'it-l10n-ithemes-security-pro' ) };
		case 4:
