...
final class Settings implements Import_Export_Source {
	...
	public function get_export_description(): string {
		return __( 'The configured settings for each Kadence Security feature.', 'it-l10n-ithemes-security-pro' );
	}
	...
	public function get_export_options_schema(): array {
		...
		return [
			...
			'description' => __( 'Select the Kadence Security features to export settings.', 'it-l10n-ithemes-security-pro' ),
			'type'        => 'array',
			'minItems'    => 1,
			'uniqueItems' => true,
			'items' => [
