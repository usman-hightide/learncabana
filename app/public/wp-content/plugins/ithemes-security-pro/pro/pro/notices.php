...
function itsec_pro_unlicensed_notice_title() {
	return esc_html__( 'Kadence Security Pro is not licensed.', 'it-l10n-ithemes-security-pro' );
}
...
function itsec_pro_unlicensed_notice_message() {
	...
	return sprintf( esc_html__( 'To receive updates, Kadence Security Pro will need to be licensed. The Kadence Licensing page can be found in the %1$sSettings menu%2$s.', 'it-l10n-ithemes-security-pro' ), '<a href="' . $url . '">', '</a>' );
}
