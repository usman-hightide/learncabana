...
/**
 * The Kadence Security Module Settings Page API parent class.
 *
...
class ITSEC_Module_Settings_Page {
	...
	/**
	 * Whether the module is part of Kadence Security Pro or not.
	 *
	 * @access protected
	 * @var bool
	 */
	...
	/**
	 * Whether the module is a Kadence Security Pro module being shown as an upsell or not.
	 *
	 * @access protected
	 * @var bool
	 */
