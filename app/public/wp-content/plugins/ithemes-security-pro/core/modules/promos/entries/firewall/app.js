			...
			<Flex direction="column" gap={ 3 } expanded={ false } align="start">
				...
				<Flex direction="column" gap={ 2 } expanded={ false }>
					...
					<Text
						variant={ TextVariant.MUTED }
						text={ installType === 'free'
							? __( 'We know creating Firewall Rules can be complex, but thanks to our Patchstack integration, Kadence Security Pro automatically patches your website vulnerabilities with no action required. Upgrade to Pro with a Patchstack license to be protected while you sleep!', 'it-l10n-ithemes-security-pro' )
							: __( 'We know creating custom Firewall Rules can be complex, but thanks to our Patchstack integration, Kadence Security automatically patches your website vulnerabilities with no action required. Upgrade to a Patchstack license and be protected while you sleep!', 'it-l10n-ithemes-security-pro' )
						}
					/>
				</Flex>
				<Button
					variant="primary"
					text={ installType === 'free'
						? __( 'Get Kadence Security Pro + Patchstack', 'it-l10n-ithemes-security-pro' )
