...
final class ITSEC_Hide_Backend_Settings extends Config_Settings {
	protected function handle_settings_changes( $old_settings ) {
		...
		ITSEC_Response::add_message( sprintf( __( 'Your new login URL is <strong><code>%1$s</code></strong>. A reminder has also been sent to the notification email addresses set in Kadence Security’s Notification Center.', 'it-l10n-ithemes-security-pro' ), esc_url( $url ) ) );
