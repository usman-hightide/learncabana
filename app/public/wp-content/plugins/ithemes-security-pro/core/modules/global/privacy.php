...
final class ITSEC_Global_Privacy {
	...
	public function get_privacy_policy_for_cookies( $policy ) {
		...
		$policy .= "<p>$suggested_text " . esc_html__( 'A cookie named “itsec_interstitial_browser” is created to track a user’s login process to implement enhanced security features.', 'it-l10n-ithemes-security-pro' ) . "</p>\n";
