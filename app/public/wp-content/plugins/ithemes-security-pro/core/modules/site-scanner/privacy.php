...
final class ITSEC_Site_Scanner_Privacy {
	...
	public function get_privacy_policy_for_sharing( $policy ) {
		...
		$policy .= "<p>$suggested_text " . __( 'This site is scanned for potential malware and vulnerabilities by the Kadence Site Scanner. We do not send personal information to the scanner; however, the scanner could find personal information posted publicly (such as in comments) during the scan.', 'it-l10n-ithemes-security-pro' ) . "</p>\n";
