...
final class ITSEC_Mail {
	...
	public function add_footer( $add_divider = true ) {
		...
		if ( ! ITSEC_Core::is_pro() ) {
			...
			$replacements = array(
				...
				'get_pro'          => esc_html__( 'Get Kadence Security Pro', 'it-l10n-ithemes-security-pro' ),
		...
		$replacements = array(
			...
			'articles_content'       =>
				sprintf(
					esc_html__(
						'Be the first to get the latest WordPress security news, tips, and updates on the %1$sKadence Blog%3$s, including the %2$sWeekly WordPress Vulnerability Report.%3$s', 'it-l10n-ithemes-security-pro'
					),
			...
			'documentation_content'  =>
				sprintf(
					esc_html__(
						'Read Kadence Security documentation and Frequently Asked Questions on the %1$sKadence Help Center.%2$s', 'it-l10n-ithemes-security-pro'
			...
			'support_content'        =>
				sprintf(
					esc_html__(
						'Pro customers have the best support team available as their security team. Contact the %1$s Kadence Help Desk%2$s for help when you need answers.', 'it-l10n-ithemes-security-pro'
			...
			'unsubscribe_link_text'  =>
				esc_html__( 'This email was generated by the Kadence Security plugin.', 'it-l10n-ithemes-security-pro' ) . '<br>' .
				sprintf(
					esc_html__(
						'To unsubscribe from these updates, visit the %1$sSettings page%2$s in the Kadence Security plugin menu.', 'it-l10n-ithemes-security-pro'
	...
	public function add_user_footer() {
		...
		$link_text = sprintf( esc_html__( 'This email was generated by the Kadence Security plugin on behalf of %s.', 'it-l10n-ithemes-security-pro' ), get_bloginfo( 'name', 'display' ) ) . '<br>';
		$link_text .= sprintf(
	...
	public function get_site_scanner_pro_callout() {
		...
		$template = $this->replace_all( $template, array(
			...
			'content'           =>
				wp_kses(
					__( 'Kadence Security Pro will <b>automatically update vulnerable plugins and themes for you</b> if a patch is available <b>so you don’t have to manually log in to update</b>.', 'it-l10n-ithemes-security-pro' ),
					'mail'
				) . ' ' .
				esc_html__( 'Get your site patched by Kadence Security Pro before hackers discover vulnerabilities on your site, all without doing a thing.', 'it-l10n-ithemes-security-pro' ) . '<br><br>' .
				sprintf(
					'<b>%s</b>',
					sprintf(
	...
	public function set_default_subject() {
		return __( 'New Notification from Kadence Security', 'it-l10n-ithemes-security-pro' );
	}
