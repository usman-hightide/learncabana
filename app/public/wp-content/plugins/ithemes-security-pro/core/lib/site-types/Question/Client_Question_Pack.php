		...
		return [
			new class implements Question, Responds {
				...
				public function get_description(): string {
					return __( 'If you are setting up Kadence Security for a client, next you‘ll select which users are theirs. Identifying your clients allows you to control their access to things like the security settings or if they are allowed to view the Security Dashboard.', 'it-l10n-ithemes-security-pro' );
				}
			...
			new class implements Question, Has_Prerequisites {
				...
				public function get_prompt(): string {
					return __( 'Should your clients be able to view and make changes to the Kadence Security settings?', 'it-l10n-ithemes-security-pro' );
				}
				...
				public function get_answer_schema(): array {
					return [
						'type'     => 'boolean',
						'title'    => __( 'Yes, allow managing of Kadence Security', 'it-l10n-ithemes-security-pro' ),
						'default'  => false,
						'uiSchema' => [
			...
			new class implements Question, Has_Prerequisites, Responds {
				...
				public function get_description(): string {
					return __( 'Kadence Security Pro will group client users together, allowing you to manage their access to sensitive information and which security settings you enable for them.', 'it-l10n-ithemes-security-pro' );
				}
			...
			new class implements Question, Has_Prerequisites, Responds {
				...
				public function get_prompt(): string {
					return __( 'Which users will manage Kadence Security on this site?', 'it-l10n-ithemes-security-pro' );
				}

				public function get_description(): string {
					return __( 'Include yourself and anyone else who will need access to Kadence Security. Grouping these users together will allow you to manage their access to sensitive information and which security settings you enable for them.', 'it-l10n-ithemes-security-pro' );
				}
