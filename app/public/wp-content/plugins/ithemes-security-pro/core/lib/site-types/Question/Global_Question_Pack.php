	...
	public function get_questions(): array {
		...
		if ( ! \ITSEC_Modules::is_active( 'security-check-pro' ) ) {
			...
			$questions[] = new class implements Question, Responds, Has_Prerequisites {
				...
				public function get_description(): string {
					return __( 'Kadence Security relies on accurately identifying the IP addresses of your site’s visitors and users to block and/or authorize them.', 'it-l10n-ithemes-security-pro' )
