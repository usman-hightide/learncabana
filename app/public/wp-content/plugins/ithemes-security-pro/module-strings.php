...
__( 'By default, Kadence Security will zip backup files to reduce file size. You may need to turn this off if you are having problems with backups.', 'it-l10n-ithemes-security-pro' );
...
__( 'Kadence Security automatically adds an IP to the ban list once it meets the Ban Threshold requirements. The Ban Threshold setting can be adjusted in the [Global Settings](itsec://settings/configure/global). You can manually add IPs to the ban list from the Security Dashboard using the Banned IPs card.', 'it-l10n-ithemes-security-pro' );
...
__( 'Sets a secure key that Kadence Security uses to encrypt sensitive values like Two-Factor codes.', 'it-l10n-ithemes-security-pro' );
__( 'Kadence Security will add a constant to your website’s <code>wp-config.php</code> file named <code>ITSEC_ENCRYPTION_KEY</code>.', 'it-l10n-ithemes-security-pro' );
...
__( 'For better security and optimized performance Kadence Security can be loaded as an MU-Plugin. Run this tool to automatically create the MU Plugin.', 'it-l10n-ithemes-security-pro' );
__( 'Remove MU Plugin Loader', 'it-l10n-ithemes-security-pro' );
__( 'For better security and optimized performance Kadence Security is being loaded as an MU-Plugin. Run this tool to automatically remove the MU Plugin.', 'it-l10n-ithemes-security-pro' );
# END MODULE: core
...
__( 'Allow users to create new Kadence Security Dashboards.', 'it-l10n-ithemes-security-pro' );
...
__( 'Feature Flags in Kadence Security allow you to try experimental features before they are released.', 'it-l10n-ithemes-security-pro' );
...
__( 'Configure basic settings that control how Kadence Security functions.', 'it-l10n-ithemes-security-pro' );
__( 'Changes made here are applied globally throughout Kadence Security’s settings. For example, the lockout settings and messages are used by all of Kadence Security’s lockout features.', 'it-l10n-ithemes-security-pro' );
__( 'Write to Files', 'it-l10n-ithemes-security-pro' );
__( 'Allow Kadence Security to write to wp-config.php and .htaccess automatically. If this box is not checked, you will need to edit those files manually.', 'it-l10n-ithemes-security-pro' );
...
__( 'How many days should Kadence Security remember a lockout? This does not affect the logs generated when creating a lockout.', 'it-l10n-ithemes-security-pro' );
...
__( 'The number of lockouts Kadence Security must remember before permanently banning the attacker.', 'it-l10n-ithemes-security-pro' );
...
__( 'The message to display to a user when their IP has been flagged as suspicious by the Kadence network.', 'it-l10n-ithemes-security-pro' );
__( 'Automatically Temporarily Authorize IPs', 'it-l10n-ithemes-security-pro' );
__( 'Whenever an administrator user accesses the website, Kadence Security will prevent their last used IP from being locked out for 24 hours.', 'it-l10n-ithemes-security-pro' );
__( 'Authorized IPs', 'it-l10n-ithemes-security-pro' );
__( 'Enter a list of IP addresses that should not be locked out by Kadence Security.', 'it-l10n-ithemes-security-pro' );
...
__( 'Configure the method Kadence Security uses to identify the IP address of your site’s visitors and users. Choose “Security Check Scan” to allow Kadence Security to automatically configure the correct method. When this setting is configured incorrectly, key firewall features will not work properly.<br>[Read more about IP Detection](https://go.solidwp.com/about-ip-detection).', 'it-l10n-ithemes-security-pro' );
...
__( 'Remove the Security Messages Menu from the Admin Bar. Notifications will only appear on the Kadence Security dashboard and settings pages.', 'it-l10n-ithemes-security-pro' );
__( 'Allow Data Sharing', 'it-l10n-ithemes-security-pro' );
__( 'Want to help shape the future of Kadence Security? Opting in shares anonymous usage data with our team at Liquid Web, the company behind Kadence Security, giving us the insights we need to keep improving the tools you rely on.<br>[Read more about usage sharing](https://go.solidwp.com/opt-in-usage-sharing).', 'it-l10n-ithemes-security-pro' );
__( 'Show Error Codes', 'it-l10n-ithemes-security-pro' );
__( 'Each error message in Kadence Security has an associated error code that can help diagnose an issue. Changing this setting to “Yes” causes these codes to be displayed. This setting should be left set to “No” unless Kadence Security\'s customer success team requests that you change it.', 'it-l10n-ithemes-security-pro' );
...
__( 'Manage Kadence Security', 'it-l10n-ithemes-security-pro' );
__( 'Allow users to manage Kadence Security.', 'it-l10n-ithemes-security-pro' );
...
__( 'Manage and configure email notifications sent by Kadence Security related to various features.', 'it-l10n-ithemes-security-pro' );
...
__( 'Kadence Security will send notifications from this email address. Leave blank to use the WordPress default.', 'it-l10n-ithemes-security-pro' );
...
__( 'Detects the correct way to identify user IP addresses based on your server configuration by making an API request to Kadence servers. No user information is sent to Kadence. [Read our Privacy Policy](https://go.solidwp.com/solid-privacy-policy).', 'it-l10n-ithemes-security-pro' );
...
__( 'Kadence Security supports multiple two-factor authentication methods: mobile apps, email messages, and backup codes. Selecting “All Methods” is highly recommended so that users can choose the method that works the best for them.', 'it-l10n-ithemes-security-pro' );
...
__( 'Kadence Security supports multiple passwordless login methods.', 'it-l10n-ithemes-security-pro' );
...
__( 'To assist with GDPR compliance, Kadence Security can prompt the user to accept the CAPTCHA provider’s Privacy Policy and Terms of Service before loading the challenge.', 'it-l10n-ithemes-security-pro' );
