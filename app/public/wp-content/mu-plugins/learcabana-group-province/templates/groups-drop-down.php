...
<div class="reporting-group-selector" id="reporting-group-selector-container">
	<form method="GET" class="reporting-group-selector__form">
		...
		<?php /* Province / DM / AM — User Report only; same markup/classes as Group for alignment. */ ?>
		<div class="reporting-group-selector__label-container lc-org-filter-item lc-province-filter-item"<?php echo $show_org_filters ? '' : ' style="display:none;"'; ?>>
			<label for="reporting-province-selector"><?php esc_html_e( 'Province', 'uncanny-learndash-reporting' ); ?></label>
		</div>
		<div class="reporting-group-selector__select-container lc-org-filter-item lc-province-filter-item lc-org-select-wrap lc-province-select-wrap"<?php echo $show_org_filters ? '' : ' style="display:none;"'; ?>>
			<select
				name="province"
		...
		<div class="reporting-group-selector__label-container lc-org-filter-item"<?php echo $show_org_filters ? '' : ' style="display:none;"'; ?>>
			<label for="reporting-district-manager-selector"><?php esc_html_e( 'District Manager', 'uncanny-learndash-reporting' ); ?></label>
		</div>
		<div class="reporting-group-selector__select-container lc-org-filter-item lc-org-select-wrap"<?php echo $show_org_filters ? '' : ' style="display:none;"'; ?>>
			<select
